...
app = FastAPI(
    title="Content Agent",
    description="Content creation agent that generates blog posts, whitepapers, social media posts, and marketing copy aligned with brand voice, SEO best practices, and content calendar schedules.",
    version="1.0.0",
    docs_url="/docs",
    redoc_url="/redoc",
    lifespan=lifespan,
