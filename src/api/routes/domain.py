"""Content Agent - Domain-Specific API Routes."""
...
@router.post("/api/v1/content/create", summary="Create or generate")
async def create(request: Request):
    """Create or generate"""
    body = await request.json() if request.method in ("POST", "PUT", "PATCH") else {}
    logger.info("create_called", params=list(body.keys()) if body else [])
    # Domain-specific handler for Content Agent
    return {
        "status": "success",
...
@router.post("/api/v1/content/analyze", summary="Analyze performance")
...
@router.post("/api/v1/content/optimize", summary="Optimize")
async def optimize(request: Request):
    ...
    return {
        "status": "success",
        "endpoint": "/api/v1/content/optimize",
...
@router.post("/api/v1/content/schedule", summary="Schedule")
...
@router.post("/api/v1/content/report", summary="Generate report")
async def report(request: Request):
    ...
    return {
        "status": "success",
        "endpoint": "/api/v1/content/report",
