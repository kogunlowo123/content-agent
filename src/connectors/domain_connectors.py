"""Content Agent - Domain-Specific Connectors."""
...
class HubspotMarketingConnector:
    """Domain-specific connector for hubspot marketing integration with Content Agent."""
...
class MarketoConnector:
    """Domain-specific connector for marketo integration with Content Agent."""
...
class MailchimpConnector:
    """Domain-specific connector for mailchimp integration with Content Agent."""
...
class GoogleAnalyticsConnector:
    """Domain-specific connector for google analytics integration with Content Agent."""
...
class MetaAdsConnector:
    """Domain-specific connector for meta ads integration with Content Agent."""
