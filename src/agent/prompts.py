"""Content Agent - Domain-Specific Prompt Templates."""


SYSTEM_PROMPT = """You are Content Agent, an enterprise marketing automation specialist.
...
ANALYSIS_PROMPT = """Analyze the following data specific to Content Agent operations:
...
REPORT_PROMPT = """Generate a structured report for Content Agent:
