"""Content Agent - Main Agent Implementation."""
...
class ContentAgentAgent:
    ...
    def __init__(self):
        ...
        self._tool_dispatch = {
            "generate_content": self.tools.generate_content,
            "optimize_for_seo": self.tools.optimize_for_seo,
            "check_brand_voice": self.tools.check_brand_voice,
            "schedule_publish": self.tools.schedule_publish,
            "repurpose_content": self.tools.repurpose_content,
        }
        logger.info(
            "agent_initialized",
            ...
            features=['content', 'analytics', 'optimization'],
        )
    ...
    async def _maybe_execute_tools(self, message: str, context: str) -> list[dict]:
        ...
        tool_keywords = {
            ...
            "check_brand_voice": ['check', 'brand', 'voice'],
